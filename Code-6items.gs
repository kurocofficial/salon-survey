// ===============================================
// ヘアサロンアンケート用 Google Apps Script (6項目対応版)
// ===============================================
...
function writeStoreData(spreadsheet, data) {
  ...
  const storeData = [
    ...
    data.store.data2023.cardCustomers || '',
    data.store.data2023.nomination || '',
    data.store.data2023.revisit || '',
    data.store.data2023.retail || '',
    // 2024年データ
    data.store.data2024.sales || '',
    data.store.data2024.customers || '',
    data.store.data2024.cardCustomers || '',
    data.store.data2024.nomination || '',
    data.store.data2024.revisit || '',
    data.store.data2024.retail || '',
    // 2025年データ
    data.store.data2025.sales || '',
    data.store.data2025.customers || '',
    data.store.data2025.cardCustomers || '',
    data.store.data2025.nomination || '',
    data.store.data2025.revisit || '',
    data.store.data2025.retail || ''
  ];
